...
CommandAlexa.wakeWords = function (req, res) {
	...
	Appel_getWakeWords(function (retourAmazon) {
		...
		fs.writeFile(fichierjson, JSON.stringify(retourAmazon, null, 2), err => { if (err) return res.sendStatus(500); });
		res.status(200).json(retourAmazon);
	});
};
...
CommandAlexa.playerInfo = function (req, res) {
	var commandeEnvoyee = req.path.replace("/", "");
	fs.writeFile("test.json", req, function(err) {
		if (err) {
			console.log(err);
		}
	});
...
function Appel_getMusicProviders(callback) {
	alexa.getMusicProviders((err, res) => {
		if (err) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getDeviceNotificationState(serialOrName, callback) {
	alexa.getDeviceNotificationState(serialOrName, (err, res) => {
		if (err) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getSmarthomeBehaviourActionDefinitions(callback) {
	alexa.getSmarthomeBehaviourActionDefinitions((err, res) => {
		if (err) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getSmarthomeGroups(callback) {
	alexa.getSmarthomeGroups((err, res) => {
		if (err) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getSmarthomeEntities(callback) {
	alexa.getSmarthomeEntities((err, res) => {
		if (err) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getDeviceStatusList(callback) {
	alexa.getDeviceStatusList((err, res) => {
		if (err) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_Playlists(serialOrName, callback) {
	alexa.Playlists(serialOrName, (err, res) => {
		if (err) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getMedia(serialOrName, callback) {
	alexa.getMedia(serialOrName, (err, res) => {
...
function Appel_getPlayerInfo(serialOrName, callback) {
	console.log("TEEEEEEEEESSSSSTTTT")
	alexa.getPlayerInfo(serialOrName, (err, res) => {
		if (err || !res) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getBluetooth(cached, callback) {
	alexa.getBluetooth(cached, (err, res) => {
		if (err || !res) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getNotificationSounds(serialOrName, callback) {
	alexa.getNotificationSounds(serialOrName, (err, res) => {
		if (err || !res) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getActivities(serialOrName, callback) {
	alexa.getActivities(serialOrName, (err, res) => {
		if (err || !res) return callback && callback();
		callback && callback(res);
	});
}
...
function Appel_getLists(serialOrName, callback) {
	alexa.getLists(serialOrName, (err, res) => {
		if (err || !res) return callback && callback();
		callback && callback(res);
	});
}
